...
function isGameOver() {
  ...
  return {gameOver:true,message:"Oyun Bitti!"};
}

function showAlert(message) {
  if(message=="Oyun Bitti!")
    alert.innerHTML = '<div>Oyun Bitti!</div> <button class="newGame" onclick="startNewGame()">Yeniden Dene</button>';
  if(message=="You won!") {
    wonGame = true;
